...
## วิธีการรัน
1. เปิด terminal หรือ cmd แล้วไปที่โฟลเดอร์ sgcu64-frontend-recruitment/Problem #2
2. รัน source code โดยใช้คำสั่ง "python chula_chana.py"

## ไอเดียเพิ่มเติม
- ใน source code นี้ผมให้ระบบ check in เป็น dictionary ใน python ซึ่งมีข้อจำกัดอยู่คือเมื่อปิดโปรแกรม 
ความจำจะหายไป ดังนั้นสิ่งที่คิดได้อีกอย่างนึงคือใช้ csv หรือ database เป็นตัวเก็บข้อมูลแทน เพื่อที่ว่าข้อมูลจะได้
ไม่หาย
